...
public class Controller {
    ...
    HashSet<Integer> ctrlFloorButtonLightsSet = new HashSet<Integer>();

    HashSet<Integer> ctrlUpButtonLightsSet = new HashSet<Integer>();

    HashSet<Integer> ctrlDownButtonLightsSet = new HashSet<Integer>();
